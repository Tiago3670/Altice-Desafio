public class Beta2 {
    ServiceType servico;
    static int id;
    Beta2(int id, ServiceType servico)
    {
        this.id=id;
    ...
    public static  ChargingReply calcularCustoBeta2(ChargingRequest request) {
        String result = null;
        double gsu=0;
        double custoTotal=0;
        boolean bucketA=false,bucketB=false, bucketC=false;

        System.out.println("Tarifario Beta2");

        double custo = 5; //centimos
